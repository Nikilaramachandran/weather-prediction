...
try:
    ...
    # Find the elements containing temperature information
    temp_raw = wd.find_elements(By.CLASS_NAME, 'rbi')
    temp_1 = []
    ...
    # Read table
    table_data = wd.find_element(By.CLASS_NAME, 'zebra.fw.tb-theme').get_attribute('outerHTML')
    ...
    print("Highest Temperature on Earth is: {} deg C and Place is: {}".format(max_temp, c_name_H))
    print("Lowest Temperature on Earth is : {} deg C and Place is: {}".format(min_temp, c_name_C))
